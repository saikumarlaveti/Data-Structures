...
public class OptionalObject {
    public static void main(String[] args) {
        ...
        System.out.println(test);  //Optional[Saikumar]

        String test1 = "Saikumar";
        String test2 = null;
        Optional<String> test3 = Optional.ofNullable(test1);
        Optional<String> test4 = Optional.ofNullable(test2);
        System.out.println(test3);   // Optional[Saikumar]
        System.out.println(test4);   // Optional.empty


        //Common Methods
     //2.1 — isPresent()
        Optional<String> test5 = Optional.of("Saikumar");
        ...
        //2.5 — orElseGet()
        Optional<String> test15 = Optional.ofNullable("Saikumar 123");
